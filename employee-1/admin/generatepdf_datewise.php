...
$result = mysqli_query($con, "SELECT eid, name, date, attendance FROM attendance_taken WHERE organisation='$organisationId' AND date='$date'") or die("database error:". mysqli_error($con));
