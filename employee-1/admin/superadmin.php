...
$query=mysqli_query($con,"SELECT * FROM organisations WHERE email='$emailUser' AND id='$organisationId'");
...
<!-- Profile of the comes here -->
    ...
    <div class="profile_div">
        <div class="div_row">
            ...
            <div class="field_value"> <h4><input name="organisation" value="<?php echo $organisation_name; ?>"></h4></div>
        </div> 
        ...
        <div class="div_row">
            ...
            <div class="field_value"> <h4><input name="email" value="<?php echo $array['email']; ?>" ></h4></div>
        </div> 
        
        <div class='div_row'>
            <div class='field_name'> <h4>Address</h4></div>
            <div class='field_value'> <h4><input name="address" maxlength="150" type="text" value="<?php echo $address; ?>"></h4></div>
        </div>
        <div class="div_row">
            <div class="field_name"> <h4>City</h4></div>
            <div class="field_value"> <h4><input name="city" value="<?php echo $array['city']; ?>"></h4></div>
        </div>  
        <div class="div_row">
            <div class="field_name"> <h4>State</h4></div>
            <div class="field_value"> <h4><input name="state" value="<?php echo $array['state']; ?>"></h4></div>
        </div> 
        <div class="div_row">
            <div class="field_name"> <h4>Contact Number</h4></div>
            <div class="field_value"> <h4><input name="contact" value="<?php echo $array['contact']; ?>"></h4></div>
        </div> 
...
if(isset($_POST['update'])){
    ...
    $update=mysqli_query($con,"UPDATE organisations SET address='$address', city='$city',state='$state',email='$email',contact='$contact',organisation='$organisation' WHERE email='$emailUser' AND id='$organisationId'");
    if($update){
        echo "<script>alert('Details Updated Successfully');</script>";
        echo "<script>location.assign('superadmin.php');</script>";
    }
    else{
